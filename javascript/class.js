...
const p = new Point()
// 实例的构造函数，就是其类原型的构造函数 constructor() 方法
console.log(p.constructor === Point.prototype.constructor) // true
// 类原型的构造函数 constructor，直接指向类本身
...
/*
  类中定义的方法都会被实例继承。如果在一个方法前，加上 static 关键字，就表示该方法不会被实例继承，
  而是直接通过类来调用，这被称为静态方法。
  如果静态方法中包含 this 关键字，则 this 指的是类，而不是实例。
  静态方法可以与非静态方法重名。
*/
class Foo {
  static classMethod () {
...
// 父类的静态方法可以被子类继承。静态方法也可以从 super 对象上调用
