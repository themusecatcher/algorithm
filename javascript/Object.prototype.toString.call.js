...
const sym = Symbol('sy') // typeof: symbol 表示独一无二的值，常用来定义对象的唯一属性名
const tru = true // typeof: boolean
const num = 5 // typeof: number
const str = 'world' // typeof: string
const nul = null // typeof: object
const undef = undefined // typeof: undefined
const formData = new FormData() // typeof: object
formData.set('data', 1)
...
console.log('type nul:', Object.prototype.toString.call(nul)) // [object Null]
console.log('type undef:', Object.prototype.toString.call(undef)) // [object Undefined]
